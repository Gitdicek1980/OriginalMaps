...
public class CourseSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_send);
    ...
    public void onClick(View v) {
        if (v == mImageView) {
            ...
            if (body.length() == 0) {
                // 質問が入力されていない時はエラーを表示するだけ
                Snackbar.make(v, "コース内容を入力して下さい", Snackbar.LENGTH_LONG).show();
                return;
            }
