...
public class AnswerSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCourse = (Course) extras.get("course");
    ...
    public void onClick(View v) {
        ...
        DatabaseReference answerRef = dataBaseReference.child(Const.ContentsPATH).child(String.valueOf(mCourse.getGenre())).child(mCourse.getCourseUid()).child(Const.AnswersPATH);
